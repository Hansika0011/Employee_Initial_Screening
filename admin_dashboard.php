...
echo "<td>
        <a href='edit_candidate.php?id={$row['id']}'>✏️ Edit</a> |
        <a href='delete_candidate.php?id={$row['id']}' onclick=\"return confirm('Are you sure you want to delete this candidate?');\">🗑️ Delete</a>
      </td>";
echo "</tr>";
...
<a href="add_recruiter.php"><button class="export-btn" style="background-color: #3498db;">➕ Add Recruiter</button></a>
    <table>
        <thead>
            <tr>
                ...
                while ($r = $recruiter_result->fetch_assoc()) {
                   echo "<td>" . htmlspecialchars($r['name']) . "</td>";
                    echo "<td>" . htmlspecialchars($r['email']) . "</td>";
                     echo "<td>
             <a href='edit_recruiter.php?id={$r['id']}'>✏️ Edit</a>
      </td>";
